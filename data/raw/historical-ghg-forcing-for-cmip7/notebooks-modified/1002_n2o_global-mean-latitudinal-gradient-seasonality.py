...
full_eofs_pcs_out_file = Path("manuscript-outputs/n2o_lat-gradient-full-eofs-pcs.nc")
...
manuscript_out_file = Path("manuscript-outputs/n2o_lat-gradient-variance-explained.csv")
