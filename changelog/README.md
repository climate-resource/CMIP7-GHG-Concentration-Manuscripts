...
so this description should be aimed to users of this repository
...
Note: the towncrier integration is currently not set up.
We may add it, but for now these changelog entries
just help us keep track of what is going on
